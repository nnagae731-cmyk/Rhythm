...
export type PremiumGuideFeatureId = 'calendar' | 'route' | 'nudge' | 'time' | 'behavior' | 'month' | 'recovery' | 'templates' | 'wish' | 'affirmation' | 'photo_design' | 'records' | 'reflection' | 'floral' | 'dot' | 'check' | 'history';

...
export const styles = StyleSheet.create({
  ...
  darkJournalSatisfaction: { borderColor: '#40506A', backgroundColor: '#181F2E' },
  darkJournalSatisfactionActive: { backgroundColor: '#26365F', borderColor: '#8EA6FF' },
  ...
  monoInlineLight: { backgroundColor: '#FFFFFF', borderColor: '#DCE2EC' },
  monoInlineDark: { backgroundColor: '#181F2E', borderColor: '#303B50' },
  monoInlineChoiceActive: { borderColor: colors.violet, shadowColor: colors.violet, shadowOpacity: 0.18, shadowRadius: 5, elevation: 2 },
  monoInlineChoiceActiveDark: { borderColor: '#6F8DFF', shadowColor: '#6F8DFF', shadowOpacity: 0.2, shadowRadius: 5, elevation: 2 },
  ...
  monoInlineDarkEyebrow: { color: '#9CA8BC', fontSize: 9, fontWeight: '900', letterSpacing: 1 },
  monoInlineDarkBrand: { color: '#FFFFFF', fontSize: 20, fontWeight: '900' },
  monoInlineDarkLine: { height: 2, backgroundColor: '#FFFFFF', width: '70%' },
  monoInlineDarkMeta: { color: '#9CA8BC', fontSize: 9, fontWeight: '700' },
  monoInlineDarkSelect: { color: '#8EA6FF', fontSize: 10, fontWeight: '900' },
  ...
  premiumFeatureTextDark: { borderTopColor: '#40506A', backgroundColor: '#20293A', borderRadius: 10, padding: 10 },
  ...
  premiumEntryCardDark: { backgroundColor: '#181F2E', borderColor: '#303B50' },
  ...
  premiumEntryTitleDark: { color: '#F4F7FC' },
  premiumEntryNumberDark: { color: '#8EA6FF' },
  ...
  reviewPhotoLargeEmpty: { width: 300, height: 180, borderRadius: 14, backgroundColor: '#F4F1F4', alignItems: 'center', justifyContent: 'center' },
    ...
    journalSatisfactionRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 11 },
    journalSatisfaction: { width: 28, height: 28, borderRadius: 14, borderWidth: 1, borderColor: '#D8D0DF', alignItems: 'center', justifyContent: 'center' },
    journalSatisfactionActive: { backgroundColor: colors.violet, borderColor: colors.violet },
    journalSatisfactionText: { color: colors.muted, fontSize: 10, fontWeight: '900' },
    journalSatisfactionTextActive: { color: '#FFFFFF' },
    journalSatisfactionLabel: { color: colors.muted, fontSize: 9, fontWeight: '800', marginLeft: 3 },

...
export const styles = StyleSheet.create({
  ...
  photoCropPreviewCopy: { color: colors.muted, fontSize: 11, lineHeight: 17, fontWeight: '700', marginTop: 6, marginBottom: 16 },
    ...
    photoCropControls: { marginTop: 14 },
    photoCropControlsLabel: { color: '#756B75', fontSize: 11, fontWeight: '900', marginBottom: 8 },
    photoCropControlRow: { flexDirection: 'row', justifyContent: 'space-between', gap: 7 },
    photoCropControlButton: { flex: 1, minHeight: 36, borderRadius: 10, borderWidth: 1, borderColor: '#DED3D8', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF' },
    photoCropControlButtonText: { color: '#6B5160', fontSize: 14, fontWeight: '900' },
  photoCropPreviewActions: { flexDirection: 'row', gap: 10, marginTop: 18 },
  photoCropPreviewSecondary: { flex: 1, minHeight: 46, borderRadius: 14, borderWidth: 1, borderColor: '#D8CBD1', alignItems: 'center', justifyContent: 'center' },
  photoCropPreviewSecondaryText: { color: '#756B75', fontSize: 13, fontWeight: '900' },
  photoCropPreviewPrimary: { flex: 1.15, minHeight: 46, borderRadius: 14, backgroundColor: '#9C5D79', alignItems: 'center', justifyContent: 'center' },
  photoCropPreviewPrimaryText: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },

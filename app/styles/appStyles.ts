...
export const styles = StyleSheet.create({
  ...
  planCountdownCardNew: { alignItems: 'stretch', flexDirection: 'column', borderLeftWidth: 4, borderWidth: 1, padding: 16 },
  ...
  planUtilityButton: { minWidth: 52, minHeight: 44, borderRadius: 12, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F7F5FA' },

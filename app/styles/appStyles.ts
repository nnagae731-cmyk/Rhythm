...
export const styles = StyleSheet.create({
  ...
  themeColorSelector: { borderRadius: 12, borderWidth: 1, overflow: 'hidden' },
  themeColorSelectorHeader: { minHeight: 44, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center' },
  themeColorSelectorSwatch: { width: 18, height: 18, borderRadius: 9, borderWidth: 1, marginRight: 9 },
  themeColorSelectorLabel: { flex: 1, fontSize: 13, fontWeight: '800' },
  themeColorSelectorChevron: { fontSize: 18, fontWeight: '700', marginLeft: 8 },
  themeColorGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, padding: 8, borderTopWidth: 1, borderTopColor: '#E6E1E4' },
  themeColorGridItem: { width: '31.8%', minHeight: 48, borderRadius: 9, borderWidth: 1, paddingHorizontal: 4, alignItems: 'center', justifyContent: 'center' },
  themeColorGridSwatch: { width: 16, height: 16, borderRadius: 8, borderWidth: 1, marginBottom: 3 },
  themeColorGridText: { fontSize: 10, lineHeight: 13, fontWeight: '800', textAlign: 'center' },

...
export const styles = StyleSheet.create({
  ...
  emptyCardMinimal: { borderRadius: 16, borderStyle: 'solid', borderColor: '#DCE2EC', backgroundColor: '#FFFFFF' },
  ...
  timeTabsMinimal: { borderRadius: 14, padding: 5, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE2EC' },
  ...
  departureCountdownCard: { backgroundColor: colors.surface, borderRadius: 16, padding: 16, marginBottom: 9, flexDirection: 'row', alignItems: 'center', borderLeftWidth: 5, borderLeftColor: '#4F6FED' },
  ...
  departureCountdownCardDark: { backgroundColor: '#181F2E', borderLeftColor: '#8EA6FF' },
  ...
  planUtilityButton: { minWidth: 52, minHeight: 44, borderRadius: 12, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, backgroundColor: '#F7F5FA' },
  planUtilityButtonDark: { backgroundColor: '#20293A', borderWidth: 1, borderColor: '#40506A' },
  ...
  premiumHeaderClose: { minWidth: 38, minHeight: 36, paddingVertical: 6, paddingHorizontal: 6, alignItems: 'center', justifyContent: 'center' },

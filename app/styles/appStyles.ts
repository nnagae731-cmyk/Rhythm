...
export const styles = StyleSheet.create({
  ...
  monoPreviewDark: { backgroundColor: '#181F2E', borderWidth: 1, borderColor: '#303B50' },
  monoPreviewPhoneLight: { backgroundColor: '#FAFAFB', borderWidth: 1, borderColor: '#E2E0E5', borderRadius: 10, padding: 9, minHeight: 164 },
  monoPreviewPhoneDark: { backgroundColor: '#181F2E', borderWidth: 1, borderColor: '#303B50', borderRadius: 10, padding: 9, minHeight: 164 },
  monoPreviewHeroLight: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D3D1D6', padding: 8, marginTop: 8 },
  monoPreviewHeroDark: { backgroundColor: '#20293A', borderWidth: 1, borderColor: '#3A4A66', padding: 8, marginTop: 8 },
  monoPreviewProgressLight: { height: 4, backgroundColor: '#24252A', width: '62%', marginTop: 9 },
  monoPreviewProgressDark: { height: 4, backgroundColor: '#6F8DFF', width: '62%', marginTop: 9 },
  ...
  monoPreviewTaskDark: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#20293A', borderBottomWidth: 1, borderBottomColor: '#3A4A66', paddingVertical: 8, marginTop: 8 },
  monoPreviewTaskDotLight: { color: '#24252A', fontSize: 13, marginRight: 6 },
  monoPreviewTaskDotDark: { color: '#6F8DFF', fontSize: 13, marginRight: 6 },
  ...
  monoPreviewEyebrowDark: { color: '#9CA8BC', fontSize: 9, fontWeight: '900', letterSpacing: 1 },
  ...
  monoPreviewCardMetaDark: { color: '#B4C0D4', fontSize: 11, marginTop: 4 },
  monoPreviewSelectDark: { color: '#8EA6FF', fontSize: 11, fontWeight: '900', marginTop: 16 },

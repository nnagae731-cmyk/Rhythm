...
export const styles = StyleSheet.create({
  ...
  planCountdownCardNew: { alignItems: 'stretch', borderLeftWidth: 4, borderWidth: 1, padding: 16 },
  ...
  planTimeColumn: { flex: 1, padding: 11, borderLeftWidth: 1 },
  ...
  patternChoice: { width: '30%', flexGrow: 0, flexShrink: 0, borderRadius: 16, borderWidth: 2, borderColor: 'transparent', backgroundColor: '#FFF3F5', padding: 6, minHeight: 104 },
  ...
  patternSwatchLarge: { height: 72, aspectRatio: 16 / 9 },

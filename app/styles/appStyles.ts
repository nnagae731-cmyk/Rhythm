...
export const styles = StyleSheet.create({
  ...
  todayHeroMinimalHint: { color: '#68748A', fontSize: 8, fontWeight: '700', textAlign: 'right', marginTop: 7, lineHeight: 12 },
  ...
  voiceAddChoiceMinimal: { borderRadius: 12, borderColor: '#DCE2EC', backgroundColor: '#FFFFFF' },
  ...
  wishShortcutDark: { backgroundColor: '#181F2E', borderColor: '#303B50' },
  ...
  homeToolCardMinimal: { borderRadius: 16, borderColor: '#DCE2EC', backgroundColor: '#FFFFFF', shadowColor: '#1B2B4A', shadowOpacity: 0.05, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 1 },

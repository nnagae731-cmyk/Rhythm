...
export const styles = StyleSheet.create({
  ...
  patternChoice: { width: '30%', flexGrow: 0, flexShrink: 0, borderRadius: 14, borderWidth: 2, borderColor: 'transparent', backgroundColor: '#FFF3F5', padding: 5, minHeight: 88 },
  ...
  patternSwatchLarge: { height: 58, aspectRatio: 16 / 9 },

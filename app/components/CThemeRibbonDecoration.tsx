...
export function CThemeRibbonDecoration({ compact = false, journal = false }: { compact?: boolean; journal?: boolean }) {
  return <View pointerEvents="none" style={styles.layer}>
    <Image source={bow} fadeDuration={0} resizeMode="contain" style={[styles.bow, compact && styles.bowCompact, journal && styles.bowJournal]} />

...
const localStyles = StyleSheet.create({
  ...
  slotPreview: { width: '100%', height: 55, borderRadius: 8, backgroundColor: '#EEE7E8' },
  slotEmpty: { width: '100%', height: 55, borderRadius: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F8EFF2' },

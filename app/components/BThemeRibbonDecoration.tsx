...
export function BThemeRibbonDecoration({ compact = false, journal = false }: { compact?: boolean; journal?: boolean }) {
  return (
    <View pointerEvents="none" style={styles.layer}>
      <Image
        ...
        fadeDuration={0}
        resizeMode="contain"
        style={[styles.bow, compact && styles.bowCompact, journal && styles.bowJournal]}
      />
      <Image
        source={diagonal}
        fadeDuration={0}
